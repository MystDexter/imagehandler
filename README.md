...
For the purpose of this assessment I opted to explore the MEAN stack (MySql, Express.JS, Angular, Node). I have zero experience developing with these Angular and Express prior to this, but I took this as a challenge to try my hands on something new and unfamiliar regardless of the outcome. The MEAN stack is one of those things i wanted to dabble into but never really had the chance to, so I'm glad I got to play with it for this assessment.
